    ...
    <ContentPage eyebrow={dict.contact.eyebrow} title={dict.contact.heading} intro={dict.contact.intro}>
      <div className="grid gap-14 lg:grid-cols-[.7fr_1.3fr]">
        <aside className="space-y-8">
          <div className="flex gap-4"><Mail className="mt-0.5 text-bronze" aria-hidden="true" size={18} /><div><h2 className="eyebrow">{dict.contact.email}</h2><a className="mt-2 block text-sm" href="mailto:concierge@priveatelier.example">concierge@priveatelier.example</a></div></div>
