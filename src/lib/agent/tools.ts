...
export const agentTools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        manufacturer: { type: "string", description: "Legal manufacturer name printed for the consumer disclosure" },
        originCountry: { type: "string", description: "Country of manufacture" },
        inci: { type: "string", description: "INCI ingredient list, only if supplied by the admin" },
        supplyChannel: { type: "string", enum: ["official", "parallel"] },
