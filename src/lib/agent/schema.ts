...
export const createProductInputSchema = z.object({
  ...
  inci: z.string().trim().min(1).max(4000).optional(),
  supplyChannel: z.enum(["official", "parallel"]).optional(),
...
export const updateProductInputSchema = z.object({
  ...
  originCountry: z.string().trim().min(1).max(120).nullable().optional(),
  inci: z.string().trim().min(1).max(4000).nullable().optional(),
  supplyChannel: z.enum(["official", "parallel"]).nullable().optional(),
