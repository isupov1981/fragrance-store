...
const en = {
  ...
  subscribers: {
    ...
    copy: "Manage who receives new-arrival emails. Blocking stops mail without deleting the address; deleting removes it permanently.",
    addTitle: "Add subscriber",
    addHelp: "Creates or reactivates an email on the mailing list.",
    add: "Add",
    adding: "Adding…",
    addOk: "Subscriber saved.",
    addFailed: "Could not add subscriber",
    listTitle: "Subscribers",
    counts: "{total} total · {active} active · {blocked} blocked",
    email: "Email",
    locale: "Language",
    status: "Status",
    statusActive: "Active",
    ...
    unblock: "Allow mail",
    delete: "Delete",
    deleteConfirm: "Permanently delete this subscriber?",
    deleteOk: "Subscriber deleted.",
...
const he: typeof en = {
  ...
  subscribers: {
    eyebrow: "רשימת תפוצה",
    copy: "ניהול מקבלי מיילים על חדשים. חסימה עוצרת דיוור בלי למחוק את הכתובת; מחיקה מסירה לצמיתות.",
    addTitle: "הוספת מנוי",
    addHelp: "יוצר או מפעיל מחדש כתובת ברשימת התפוצה.",
    add: "הוספה",
    adding: "מוסיף…",
    addOk: "המנוי נשמר.",
    addFailed: "לא ניתן להוסיף מנוי",
    listTitle: "מנויים",
    counts: "{total} סה״כ · {active} פעילים · {blocked} חסומים",
    email: "אימייל",
    locale: "שפה",
    status: "סטטוס",
    statusActive: "פעיל",
    ...
    unblock: "הפעלת דיוור",
    delete: "מחיקה",
    deleteConfirm: "למחוק את המנוי לצמיתות?",
    deleteOk: "המנוי נמחק.",
