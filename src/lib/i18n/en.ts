...
export const en = {
  ...
  consent: {
    ...
    save: "Save choices",
    necessary: "Essential",
    necessaryCopy: "Language, currency, cart, saved fragrances, accessibility and your cookie choice.",
    analytics: "Analytics",
  ...
  home: {
    ...
    heroAlt: "Silent film of fragrance bottles. No dialogue. Playback is muted.",
  ...
  product: {
    view: "View {name}",
    from: "From {price}",
    vatInclusive: "Incl. Israeli VAT",
    vatAbroad:
      "Delivery outside Israel uses this same catalogue price. Israeli VAT is not removed, and no foreign sales tax is added. Customs duties in the destination country, if charged, are paid by you.",
    vatFx: "Shown in another currency as a conversion of the Israeli price. Israeli VAT is still included.",
    ...
    supplyUnknown: "The supply route is printed on the packaging. Parallel import is marked here when it applies.",
    onPack: "Printed on the packaging. Stated in the order confirmation when we hold it.",
    ingredientsOnPack: "The ingredient list is printed on the packaging.",
    warnings: "Warnings",
    warningAlcohol: "Contains alcohol. Flammable. Keep away from heat and flame.",
    warningChildren: "Keep out of reach of children.",
    warningExternal: "For external use on skin only. Stop if irritation occurs.",
    edp: "Eau de parfum",
    extrait: "Extrait",
  ...
  favorites: {
    ...
    intro: "Keep the bottles you want to revisit — saved on this device.",
    empty: "No saved fragrances yet.",
    browse: "Browse the collection",
    loading: "Loading saved fragrances…",
    save: "Save {name}",
  ...
  cart: {
    ...
    shippingNote: "Prices include Israeli VAT. Shipping is calculated at checkout.",
    checkout: "Checkout",
    item: "item",
    items: "items",
  ...
  checkout: {
    ...
    vatInclusive: "Prices include Israeli VAT.",
    vatExport:
      "Delivery is outside Israel. This amount is the Israeli catalogue price and includes Israeli VAT; that VAT is not removed. No foreign sales tax is added. Customs duties in the destination country, if charged, are paid by you.",
