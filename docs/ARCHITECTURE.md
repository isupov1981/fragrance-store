# Архитектура — Privé Atelier

Документ описывает текущую архитектуру интернет-магазина ароматов **Privé Atelier** (`prive-atelier-store`): слои приложения, потоки данных, интеграции и границы ответственности.
